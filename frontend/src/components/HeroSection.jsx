  ...
  return (
    <section className="relative h-screen flex flex-col items-center justify-center overflow-hidden hero-section">
      ...
      <div className="relative z-10 w-full max-w-7xl px-6 flex flex-col items-center">
        ...
        <div
          className="w-full flex justify-end max-w-7xl absolute -top-24"
          style={{ right: '-100px' }}
        >
          <div className="glass-panel px-8 py-4 flex items-center gap-6">
            <span className="font-label text-[12px] tracking-widest text-on-background/70">
              LEVEL
            </span>
            <span className="font-headline font-light text-5xl text-on-background">
              724 .-.</span>
          </div>
        </div>
      </div>
